  	...
  	<div class="adminReservation_wrap2">
					...
					<div class="n_search" border="1" width="90%" >
						...
						<div class="n_search" border="1" width="90%">
							...
							<div class="form-group">
								<select name="type" id="type" class="form-controller">
		...
		<c:otherwise>
			<div class="col-md-15">
           	...
           	<br><br><br><br> <h5>키워드에 해당하는 정보가 없습니다. <br>
           				 검색유형에 맞는지 확인하신 후 다시 검색해주세요.
           		<input class="btn btn-primary" type="button" value = "뒤로가기" onclick="javascript:history.back();"></h5><br><br><br>
           	</div>
		</c:otherwise>
		</c:choose>
	</div>
